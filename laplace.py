...
if __name__ == "__main__":
    ...
    print(omega.is_complex)
    transform = sympy.parsing.sympy_parser.standard_transformations
    transform[1].__annotations__ = {"real":True}
    sym_value = sympy.parse_expr("G", transformations=transform)
    print(sym_value)
    print(sympy.sympify(sym_value).is_real)
    print(sympy.srepr(sym_value))
